...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <meta name="twitter:title" content="x.digimar.id – Maksimalkan Cuitan, Jangkau Audiens Lebih Luas">
      <meta name="twitter:description" content="Kelola, jadwalkan, dan analisa akun X (Twitter) Anda dari satu tempat. Gunakan strategi konten cerdas untuk membangun branding dan interaksi.">
